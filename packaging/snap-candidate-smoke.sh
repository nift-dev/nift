...
# installed version and revision, exercises the classic-confinement surface
# (version/help, project creation, a real build, dependency-driven rebuilding,
# unrestricted filesystem access, and project-local .nift/ state), then
...
# Disposable project under $HOME: classic confinement grants unrestricted access, so a
